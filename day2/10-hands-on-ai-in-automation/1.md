...
3. **Choose a Local Folder**  
   ...
   - Once the clone completes, choose the option to open the cloned repository.  
...
4. **Verify the Repository Structure**  
   ...
   - `assets/Cursor - Agent - Prompt.md` (the AI agent prompt file)  
